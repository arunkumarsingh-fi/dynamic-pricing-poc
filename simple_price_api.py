...
class SimplePriceEngine:
    ...
    def estimate_market_price(self, device_info):
        """Estimate market price based on device specifications"""
        ...
        base_value = 50000  # Base LKR value
        storage_value = storage * 150
        ram_value = ram * 8000
        camera_value = camera * 2000
        ...
        estimated_price = (base_value + storage_value + ram_value + camera_value) * battery_multiplier * (1 - damage_penalty)
