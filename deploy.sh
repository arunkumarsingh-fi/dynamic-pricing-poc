...
# Full Circle Exchange - Podman Deployment Script
...
echo "🔄 Full Circle Exchange: Podman Deployment"
echo "=========================================="
...
# Function to clean up any stale containers/networks
cleanup_podman() {
...
deploy() {
    echo "🚀 Starting Full Circle Exchange deployment..."
    ...
    if podman ps | grep -q "full-circle-ml" && podman ps | grep -q "full-circle-ui"; then
        echo ""
        echo "🎉 Full Circle Exchange deployed successfully!"
        echo ""
...
case "${1:-deploy}" in
    "deploy"|"start")
        ...
        ;;
    "stop")
        echo "🛑 Stopping Full Circle Exchange..."
        podman-compose -f podman-compose.yml down
        echo "✅ Stopped successfully"
        ;;
    "restart")
        echo "🔄 Restarting Full Circle Exchange..."
        podman-compose -f podman-compose.yml down
        sleep 2
